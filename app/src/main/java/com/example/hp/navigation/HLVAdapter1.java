...
public class HLVAdapter1 extends RecyclerView.Adapter<HLVAdapter1.ViewHolder> {
    ...
    public HLVAdapter1(Context context, ArrayList<String> alName, ArrayList<Integer> alImage) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.grid_item_offer, viewGroup, false);
...
/*
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imgThumbnail = (ImageView) itemView.findViewById(R.id.img_thumbnail1);
            tvSpecies = (TextView) itemView.findViewById(R.id.tv_species1);
