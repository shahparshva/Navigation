...
public class BackgroundTask_remove extends AsyncTask<String,Void,String> {
    AlertDialog alertDialog;
    Context ctx;
   // CustomListAdapter c;
    public BackgroundTask_remove(Context ctx)
    {
  ...
  /*  public BackgroundTask_remove(CustomListAdapter customListAdapter)
    ...
    protected String doInBackground(String... params) {
        String reg_url="https://parshva.000webhostapp.com/new/delete.php";
